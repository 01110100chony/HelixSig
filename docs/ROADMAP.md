...
| H6 | Release candidate and study | TECH_PASS | Final candidate identified in external exact-commit attestation; clean checkout, CI-equivalent gate, docs/study and AI reviews passed; human approval separate |
